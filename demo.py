...
def show(line, sanBasicTokenizer, bertBasicTokenizer):
    tokens1 = sanBasicTokenizer.tokenize(line)
    tokens2 = bertBasicTokenizer.tokenize(line)
    print("SanBasicTokenizer", ' '.join(tokens1))
    print("BertBasicTokenizer", ' '.join(tokens2))
